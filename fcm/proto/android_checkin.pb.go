...
// Information about the device that is checking in.
type AndroidCheckinProto struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Milliseconds since the Unix epoch of the device's last successful checkin.
	...
	Type *int32 `protobuf:"varint,12,opt,name=type,def=1" json:"type,omitempty"` // Default to DEVICE_ANDROID_OS
...
const (
	Default_AndroidCheckinProto_Type = int32(1)
)
...
const file_android_checkin_proto_rawDesc = "" +
	...
	"\x0fCHANNEL_UNKNOWN\x10\x05\"\x9f\x02\n" +
	...
	"userNumber\x12\x15\n" +
	"\x04type\x18\f \x01(\x05:\x011R\x04type\x12B\n" +
	...
	"\x10DEVICE_CHROME_OS\x10\x04B1H\x03Z-github.com/chickenfresh/go-rustplus/fcm/proto"
...
var file_android_checkin_proto_depIdxs = []int32{
	...
	3, // 2: checkin_proto.AndroidCheckinProto.chrome_build:type_name -> checkin_proto.ChromeBuildProto
